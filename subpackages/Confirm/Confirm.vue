	...
	<view class="flow-checkout-header dis-flex">
		<view class="padding-box">
			...
			<view class="two">
				...
				<view class="checkout-address" v-text="xqObj.address.region.city+' '+xqObj.address.region.province+' '+xqObj.address.region.region+' '+xqObj.address.detail">
		...
		<view class="box-list">
			...
			<view class="order-box b-f">
				<view class="order-cont">
					<view class="order-time"> <text style="font-size: 28upx;font-weight: 600;" v-text="'共'+xqObj.order_total_num+'件商品,'"></text> </view>
					<view class="order-time">
						
						<text style="color:#ff495e;font-size: 28upx;font-weight: 600;" v-text="'合计:'+xqObj.order_total_price"></text>
